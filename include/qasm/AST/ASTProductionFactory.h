...
public:
  static ASTProductionFactory &Instance() { return APF; }
  ...
  ASTDeclarationNode *
  ProductionRule_106(const ASTToken *TK, const ASTIdentifierNode *DId,
  ...
  ASTDeclarationNode *
  ProductionRule_112(const ASTToken *TK, const ASTIdentifierNode *Id,
                     const ASTFunctionCallStatementNode *FC) const;
  ...
  // IntScalarType
  ASTIntNode *ProductionRule_802(const ASTToken *TK, ASTType ITy) const;
  ...
  // Bound / Unbound Qubit
  ASTStringNode *ProductionRule_814(const ASTToken *TK, ASTType QTy) const;
  ...
  // Array parameters
  ASTArrayNode *ProductionRule_821(
      const ASTToken *TK,
  ...
  // Array expressions
  ASTArrayNode *ProductionRule_822(
  ...
  ASTDeclarationNode *ProductionRule_850(const ASTToken *TK,
                                         const ASTIdentifierNode *Id,
                                         ASTType Ty, bool Const = false) const;
  ASTDeclarationNode *ProductionRule_850(const ASTToken *TK,
                                         const ASTIdentifierNode *Id,
                                         const ASTStringNode *TS, ASTType Ty,
                                         bool Const = false) const;
  ASTDeclarationNode *ProductionRule_850(
      const ASTToken *TK, const ASTIdentifierNode *Id,
      const std::variant<const ASTIntNode *, const ASTIdentifierNode *> &II,
      ASTType Ty, bool Const = false) const;
  ASTDeclarationNode *ProductionRule_850(const ASTToken *TK,
  ...
  ProductionRule_870(const ASTToken *TK, const ASTIdentifierNode *TId) const;
  ...
  ASTDeclarationNode *ProductionRule_1103(const ASTToken *TK,
                                          ...
                                          const ASTExpressionNode *EN) const;
  ASTDeclarationNode *
  ProductionRule_1104(const ASTToken *TK, const ASTIdentifierNode *DId,
                      const ASTFunctionCallStatementNode *FC) const;
  ...
  ASTDeclarationNode *ProductionRule_141(const ASTToken *TK,
                                         ...
                                         const ASTExpressionNode *EN) const;
  ASTDeclarationNode *
  ProductionRule_142(const ASTToken *TK, const ASTIdentifierNode *Id,
                     const ASTFunctionCallStatementNode *FC) const;
  ...
  ASTDeclarationNode *ProductionRule_181(const ASTToken *TK,
                                         ...
                                         const ASTExpressionNode *EN) const;
  ASTDeclarationNode *
  ProductionRule_182(const ASTToken *TK, const ASTIdentifierNode *Id,
                     const ASTFunctionCallStatementNode *FC) const;
  ...
  ASTDeclarationNode *ProductionRule_202(const ASTToken *TK,
                                         ...
                                         const ASTExpressionNode *EN) const;
  ASTDeclarationNode *
  ProductionRule_203(const ASTToken *TK, const ASTIdentifierNode *DId,
  ...
  ASTDeclarationNode *ProductionRule_204(const ASTToken *TK,
                                         ...
                                         const ASTExpressionNode *EN) const;
  ASTDeclarationNode *
  ProductionRule_205(const ASTToken *TK, const ASTIdentifierNode *DId,
                     const ASTIdentifierNode *IXd,
                     const ASTFunctionCallStatementNode *FC) const;
  ...
  ASTUnaryOpNode *ProductionRule_300(const ASTToken *TK, const __Type *TP,
                                     ASTOpType OTy) const;

  // Pow Binary Ops
  template <typename __Base, typename __Exponent>
  ASTBinaryOpNode *ProductionRule_310(const ASTToken *TK, const __Base *B,
  ...
  template <typename __Type>
  ASTUnaryOpNode *ProductionRule_350(const ASTToken *TK, const __Type *TP,
                                     ASTOpType OTy, bool Parens = false) const;

  // Bit Rotation
  ASTRotateNode *ProductionRule_310(
      const ASTToken *TK,
  ...
  ASTBinaryOpNode *
  ProductionRule_452(const ASTToken *TK, const ASTIdentifierNode *Id,
  ...
  // binary op statement
  ASTBinaryOpStatementNode *ProductionRule_605(const ASTToken *TK,
                                               ASTBinaryOpNode *BOP) const;
  ...
  ASTDelayNode *ProductionRule_1300(const ASTToken *TK,
                                    const ASTIdentifierNode *Id) const;
  ASTDelayNode *ProductionRule_1300(const ASTToken *TK, const ASTStringNode *TS,
  ...
  ProductionRule_1434(const ASTToken *TK, const std::string *GS,
                      const ASTLocation &Loc, ASTDeclarationList *DL,
  ...
  ProductionRule_1440(const ASTToken *TK, const ASTIdentifierNode *Id,
                      ASTExpressionList *DEL, ASTBoundQubitList *BQL,
                      ASTStatementList *DSL,
                      const ASTStringNode *GS = nullptr) const;
  ASTDefcalDeclarationNode *
  ProductionRule_1441(const ASTToken *TK, const ASTIdentifierNode *Id,
                      ASTBoundQubitList *BQL, ASTStatementList *DSL,
                      const ASTStringNode *GS = nullptr) const;
  ASTDefcalDeclarationNode *
  ProductionRule_1442(const ASTMeasureNode *MN, const ASTToken *TK,
                      ASTStatementList *DSL,
                      const ASTStringNode *GS = nullptr) const;
  ASTDefcalDeclarationNode *
  ProductionRule_1443(const ASTToken *DTK, const ASTToken *RTK,
                      ASTIdentifierNode *QId, ASTStatementList *DSL,
                      const ASTStringNode *GS = nullptr) const;
  ASTDefcalDeclarationNode *
  ProductionRule_1444(const ASTToken *DTK, const ASTToken *DLTK,
                      const ASTStringNode *TS, ASTBoundQubitList *QL,
                      ASTStatementList *DSL,
                      const ASTStringNode *GS = nullptr) const;
  ASTDefcalDeclarationNode *
  ProductionRule_1445(const ASTToken *DTK, const ASTToken *DLTK,
                      ASTDurationOfNode *DRN, ASTBoundQubitList *QL,
                      ASTStatementList *DSL,
                      const ASTStringNode *GS = nullptr) const;
  ASTDefcalDeclarationNode *
  ProductionRule_1445(const ASTToken *DTK, const ASTToken *DRTK,
                      const ASTIdentifierNode *DId, ASTBoundQubitList *QL,
                      ASTStatementList *DSL,
                      const ASTStringNode *GS = nullptr) const;
  ...
  ASTMeasureNode *ProductionRule_1462(const ASTToken *TK,
                                      const ASTIdentifierNode *TId) const;
  ASTMeasureNode *
  ProductionRule_1463(const ASTToken *TK, const std::string &TS,
                      const ASTToken *TSTK, const ASTIntNode *TIMin,
                      const ASTIntNode *TIMax, const std::string &RS,
  ...
  ASTIdentifierNode *ProductionRule_1505(const ASTToken *TK,
                                         ...
                                         const std::string &IS) const;
  ASTIdentifierNode *
  ProductionRule_1506(const ASTToken *TK, const ASTStringNode *BQS,
                      const ASTArraySubscriptNode *ASN,
  ...
  ProductionRule_1520(const ASTToken *TK, const ASTIdentifierNode *IId) const;
  ASTArraySubscriptNode *ProductionRule_1520(const ASTToken *TK,
                                             const ASTBinaryOpNode *BOP) const;
  ASTArraySubscriptNode *ProductionRule_1520(const ASTToken *TK,
                                             const ASTUnaryOpNode *UOP) const;
  ...
  ProductionRule_1700(const ASTToken *TKF, const ASTIdentifierNode *Id,
                      const ASTExpressionList *EL) const;
  OpenPulse::ASTOpenPulseFrameNode *
  ProductionRule_1701(const ASTToken *TKF, const ASTIdentifierNode *Id) const;
  OpenPulse::ASTOpenPulseFrameNode *
  ProductionRule_1702(const ASTToken *TKF, const ASTExpressionList *EL) const;

  // OpenPulse Port
  OpenPulse::ASTOpenPulsePortNode *
  ProductionRule_1710(const ASTToken *TK, const ASTIdentifierNode *Id) const;

  // OpenPulse Waveform
  OpenPulse::ASTOpenPulseWaveformNode *
  ProductionRule_1720(const ASTToken *TK, const ASTIdentifierNode *Id,
                      const ASTExpressionList *EL) const;
  OpenPulse::ASTOpenPulseWaveformNode *
  ProductionRule_1721(const ASTToken *TK, const ASTIdentifierNode *Id,
                      const ASTFunctionCallStatementNode *FC) const;

  // OpenPulse Play
  OpenPulse::ASTOpenPulsePlayNode *
  ProductionRule_1730(const ASTToken *TK, const ASTIdentifierNode *FId,
                      const ASTExpressionList *EL) const;
  OpenPulse::ASTOpenPulsePlayNode *
  ProductionRule_1731(const ASTToken *TK, const ASTExpressionList *EL,
  ...
  OpenPulse::ASTOpenPulsePlayNode *
  ProductionRule_1733(const ASTToken *TK, const ASTIdentifierNode *WId,
                      const ASTIdentifierNode *FId) const;
  OpenPulse::ASTOpenPulsePlayNode *
  ProductionRule_1734(const ASTToken *TK, const ASTIdentifierNode *WId,
                      const OpenPulse::ASTOpenPulseFrameNode *FN) const;
  OpenPulse::ASTOpenPulsePlayNode *
  ProductionRule_1735(const ASTToken *TK,
                      ...
                      const OpenPulse::ASTOpenPulseFrameNode *FN) const;
  OpenPulse::ASTOpenPulsePlayNode *
  ProductionRule_1736(const ASTToken *TK, const ASTFunctionCallNode *FCN,
                      const ASTIdentifierNode *FId) const;
  OpenPulse::ASTOpenPulsePlayNode *
  ProductionRule_1737(const ASTToken *TK, const ASTFunctionCallNode *FCN,
                      const OpenPulse::ASTOpenPulseFrameNode *FN) const;

  // OpenPulse Calibration
  OpenPulse::ASTOpenPulseCalibration *
  ProductionRule_1740(const ASTToken *TK, ASTStatementList *OPSL) const;
  ...
  // Return Statement
  ASTReturnStatementNode *ProductionRule_2000(const ASTToken *TK,
                                              ASTExpressionNode *EN) const;

  ASTReturnStatementNode *ProductionRule_2001(const ASTToken *TK,
                                              ASTIdentifierNode *Id) const;

  ASTReturnStatementNode *ProductionRule_2002(const ASTToken *TK,
                                              ASTBinaryOpNode *BOP) const;
  ...
  ASTReturnStatementNode *ProductionRule_2004(const ASTToken *TK,
                                              ASTMeasureNode *MN) const;

  ASTReturnStatementNode *ProductionRule_2005(const ASTToken *TK) const;

  ASTReturnStatementNode *ProductionRule_2006(const ASTToken *TK,
  ...
  ProductionRule_2504(const ASTToken *ETK, ASTIdentifierNode *Id,
                      ASTDeclarationList *DL, ASTStatementList *SL,
  ...
  ASTForStatementNode *ProductionRule_3210(const ASTToken *TK, ASTIntNode *IVT,
                                           ...
                                           ASTForLoopRangeExpressionNode *FLR,
                                           ASTStatementList *SL) const;
  ASTForStatementNode *ProductionRule_3211(const ASTToken *TK, ASTIntNode *IVT,
                                           ASTIdentifierNode *LId,
                                           ASTForLoopRangeExpressionNode *FLR,
                                           ASTStatement *ST) const;
  ...
  ASTCastExpressionNode *ProductionRule_3600(const ASTToken *TK,
                                             ...
                                             ASTType Ty) const;
  ASTCastExpressionNode *ProductionRule_3600(
      const ASTToken *TK,
      const std::variant<const ASTIntNode *, const ASTIdentifierNode *> &II,
      const ASTExpressionNode *EXN, ASTType Ty) const;

  // Scalar Types
  ASTIntNode *ProductionRule_3700(const ASTToken *TK, ASTSignbit SB) const;
  ...
  // Param Type Decl
  template <typename __Type>
  ASTDeclarationNode *ProductionRule_3800(const ASTToken *TK, const __Type *TP,
                                          ASTType Ty, bool Const = false) const;
  ...
  ASTGateControlNode *ProductionRule_3850(const ASTToken *TK,
                                          const __Type *TP) const;
  template <typename __Type>
  ASTGateControlNode *ProductionRule_3850(const ASTToken *TK, const __Type *TP,
                                          const ASTIntNode *I) const;
  template <typename __Type>
  ASTGateControlNode *ProductionRule_3850(const ASTToken *TK,
  ...
  ASTGatePowerNode *ProductionRule_3852(const ASTToken *TK, const __Type *TP,
