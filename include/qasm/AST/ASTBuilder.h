...
public:
  static ASTBuilder &Instance() { return Builder; }
  ...
  ASTBinaryOpNode *CreateASTBinaryOpNode(const std::string &Identifier,
                                         ...
                                         ASTOpType OT, bool Parens = false);
  ASTBinaryOpNode *CreateASTBinaryOpNode(const std::string &Identifier,
  ...
  ASTBinaryOpNode *CreateASTBinaryOpNode(const std::string &Identifier,
                                         const std::string &L,
                                         const std::string &R, ASTOpType OT,
                                         bool Parens = false);
  ASTBinaryOpNode *CreateASTArithNegateBinaryOpNode(const ASTIdentifierNode *Id,
                                                    const std::string &BON);

  ASTUnaryOpNode *CreateASTUnaryOpNode(const std::string &Identifier,
                                       const ASTExpressionNode *R, ASTOpType OT,
                                       bool HasParen = false,
                                       bool IsLValue = false);
  ASTUnaryOpNode *CreateASTUnaryOpNode(const std::string &Identifier,
                                       const ASTIdentifierNode *Id,
                                       ASTOpType OT, bool HasParen = false,
                                       bool IsLValue = false);
  ...
  CreateASTIntNode(uint32_t Value,
                   const ASTCVRQualifiers &CVR = ASTCVRQualifiers());
  ASTIntNode *
  CreateASTIntNode(const ASTIdentifierNode *Id, int32_t Value,
                   const ASTCVRQualifiers &CVR = ASTCVRQualifiers());
  ASTIntNode *
  CreateASTIntNode(const ASTIdentifierNode *Id, uint32_t Value,
                   const ASTCVRQualifiers &CVR = ASTCVRQualifiers());
  ASTIntNode *
  CreateASTIntNode(const ASTIdentifierNode *Id, const ASTExpressionNode *E,
                   bool Unsigned = false,
                   const ASTCVRQualifiers &CVR = ASTCVRQualifiers());
  ASTFloatNode *
  ...
  CreateASTFloatNode(const ASTIdentifierNode *Id, float Value,
                     const ASTCVRQualifiers &CVR = ASTCVRQualifiers());
  ASTFloatNode *
  CreateASTFloatNode(const ASTIdentifierNode *Id, const ASTExpressionNode *E,
                     const ASTCVRQualifiers &CVR = ASTCVRQualifiers());
  ...
  CreateASTDoubleNode(const ASTIdentifierNode *Id, double Value,
                      const ASTCVRQualifiers &CVR = ASTCVRQualifiers());
  ASTDoubleNode *
  CreateASTDoubleNode(const ASTIdentifierNode *Id, const ASTExpressionNode *E,
                      const ASTCVRQualifiers &CVR = ASTCVRQualifiers());
  ...
  ASTIdentifierNode *FindASTIdentifierNode(const std::string &Id, unsigned Bits,
                                           ASTType Type);
  ASTIdentifierNode *FindASTIdentifierNode(const std::string &Id, ASTType Type);
  unsigned FindASTIdentifierNode(const std::string &Id, unsigned Bits,
                                 ASTType Type,
                                 std::vector<ASTSymbolTableEntry *> &STV);

  ASTIdentifierNode *CreateASTIdentifierNode(const std::string &Id);
  ASTIdentifierNode *
  CreateASTIdentifierNode(const std::string &Id, unsigned Bits, ASTType Type,
                          const ASTDeclarationContext *DCX = nullptr,
                          bool TypeSystemBuilder = false);
  ASTIdentifierNode *CreateLocalScopeASTIdentifierNode(
  ...
  ASTMPIntegerNode *CreateASTMPIntegerNode(const ASTIdentifierNode *Id,
                                           ...
                                           bool Unsigned = false);
  ASTMPIntegerNode *CreateASTMPIntegerNode(const ASTIdentifierNode *Id,
                                           unsigned Bits, const ASTIntNode *I);
  ASTMPIntegerNode *
  CreateASTMPIntegerNodeFromExpression(const ASTIdentifierNode *Id,
                                       unsigned Bits, ASTExpressionNode *EN,
                                       bool Unsigned = false);
  ...
  ASTMPDecimalNode *CreateASTMPDecimalNode(const ASTIdentifierNode *Id,
                                           unsigned Bits, const char *String);
  ASTMPDecimalNode *CreateASTMPDecimalNode(const ASTIdentifierNode *Id,
                                           unsigned Bits, const mpfr_t &MPFR);
  ASTMPDecimalNode *CreateASTMPDecimalNode(const ASTIdentifierNode *Id,
  ...
  ASTMPDecimalNode *CreateASTMPDecimalNodeFromExpression(
  ...
  CreateASTMPComplexNode(const ASTIdentifierNode *Id,
                         ...
                         unsigned NumBits = ASTMPComplexNode::DefaultBits);
  ASTMPComplexNode *
  CreateASTMPComplexNode(const ASTIdentifierNode *Id, const ASTMPDecimalNode *R,
                         const ASTMPDecimalNode *I, ASTOpType OT,
                         unsigned NumBits = ASTMPComplexNode::DefaultBits);
  ASTMPComplexNode *
  CreateASTMPComplexNode(const ASTIdentifierNode *Id, const ASTMPIntegerNode *R,
  ...
  CreateASTMPComplexNode(const ASTIdentifierNode *Id, const ASTMPIntegerNode *R,
                         ...
                         unsigned NumBits = ASTMPComplexNode::DefaultBits);
  ASTMPComplexNode *
  CreateASTMPComplexNode(const ASTIdentifierNode *Id, const std::string &REP,
                         unsigned NumBits = ASTMPComplexNode::DefaultBits);
  ASTMPComplexNode *
  CreateASTMPComplexNode(const ASTIdentifierNode *Id,
  ...
  CreateASTMeasureNode(const ASTIdentifierNode *Id,
                       ASTQubitContainerNode *Target, ASTCBitNode *Result,
                       unsigned RIX = static_cast<unsigned>(~0x0));
  ASTMeasureNode *
  CreateASTMeasureNode(const ASTIdentifierNode *Id,
                       ASTQubitContainerNode *Target, ASTAngleNode *Result,
                       unsigned RIX = static_cast<unsigned>(~0x0));
  ASTMeasureNode *
  CreateASTMeasureNode(const ASTIdentifierNode *Id,
                       ASTQubitContainerNode *Target, ASTMPComplexNode *Result,
                       unsigned RIX = static_cast<unsigned>(~0x0));

  ASTQRegNode *CreateASTQRegNode(const ASTIdentifierNode *Id,
                                 unsigned NumQubits);

  ASTCRegNode *CreateASTCRegNode(const ASTIdentifierNode *Id, unsigned NumBits);
  ASTCRegNode *CreateASTCRegNode(const ASTIdentifierNode *Id,
                                 const std::vector<unsigned> &BV);

  ASTAngleNode *CreateASTAngleNode(const std::string &Id, ASTAngleType ATy,
                                   unsigned NumBits = ASTAngleNode::AngleBits);
  ASTAngleNode *CreateASTAngleNode(const ASTIdentifierNode *Id,
                                   ASTAngleType ATy,
                                   unsigned NumBits = ASTAngleNode::AngleBits);
  ASTAngleNode *CreateASTAngleNode(const ASTIdentifierNode *Id, uint64_t W,
                                   uint64_t X, uint64_t Y, uint64_t Z,
                                   ASTAngleType ATy,
                                   unsigned NumBits = ASTAngleNode::AngleBits);
  ASTAngleNode *CreateASTAngleNode(const ASTIdentifierNode *Id,
                                   const ASTExpressionNode *E, ASTAngleType ATy,
                                   unsigned NumBits = ASTAngleNode::AngleBits);
  ASTAngleNode *CreateASTAngleNode(const ASTIdentifierNode *Id,
                                   ASTAngleType ATy, const mpfr_t &MPV,
                                   unsigned NumBits = ASTAngleNode::AngleBits);
  ...
  ASTAngleNode *CloneASTAngleNode(const ASTIdentifierNode *Id,
                                  const ASTAngleNode *AN, unsigned NumBits);
  ...
  ASTCBitNode *CreateASTCBitNode(const ASTIdentifierNode *Id, std::size_t Size,
                                 std::size_t Bitmask);
  ASTCBitNode *CreateASTCBitNode(const ASTIdentifierNode *Id, std::size_t Size,
  ...
  ASTResultNode *CreateASTResultNode(const ASTIdentifierNode *Id, ASTType RTy,
                                     unsigned NumBits = 0U,
                                     ASTSignbit SB = ASTSignbit::Signed);

  ASTFunctionDefinitionNode *CreateASTFunctionDefinition(
      const ASTIdentifierNode *Id, const ASTDeclarationList &PDL,
      const ASTStatementList &SL, ASTResultNode *RES, bool IsDefinition = true);

  ASTFunctionDeclarationNode *
  CreateASTFunctionDeclaration(const ASTIdentifierNode *Id,
                               const ASTFunctionDefinitionNode *FDN);

  ASTKernelNode *CreateASTKernelNode(const ASTIdentifierNode *Id,
  ...
  ASTReturnStatementNode *
  CreateASTReturnStatementNode(const ASTIdentifierNode *Id, ASTMeasureNode *MN);
  ASTPopcountNode *CreateASTPopcountNode(const ASTIdentifierNode *Id,
                                         const ASTIntNode *I);
  ASTPopcountNode *CreateASTPopcountNode(const ASTIdentifierNode *Id,
  ...
  ASTRotateNode *CreateASTRotateNode(const ASTIdentifierNode *Id,
                                     const ASTIntNode *I, const ASTIntNode *S,
                                     ASTRotationType OpTy);
  ASTRotateNode *CreateASTRotateNode(const ASTIdentifierNode *Id,
                                     const ASTMPIntegerNode *MPI,
                                     const ASTIntNode *S, ASTRotationType OpTy);
  ASTRotateNode *CreateASTRotateNode(const ASTIdentifierNode *Id,
                                     const ASTCBitNode *CBI,
                                     const ASTIntNode *S, ASTRotationType OpTy);

  ASTDefcalNode *CreateASTDefcalNode(const ASTIdentifierNode *Id,
  ...
  ASTDefcalGroupNode *CreateASTDefcalGroupNode(const ASTIdentifierNode *Id);

  ASTDefcalDeclarationNode *
  CreateASTDefcalDeclaration(const ASTIdentifierNode *Id,
                             const ASTDefcalNode *DN);

  ASTDurationNode *CreateASTDurationNode(const ASTIdentifierNode *Id,
  ...
  ASTDurationOfNode *CreateASTDurationOfNode(const ASTIdentifierNode *Id,
  ...
  ASTLengthNode *CreateASTLengthNode(const ASTIdentifierNode *Id,
                                     const std::string &Units);
  ASTLengthNode *CreateASTLengthNode(const ASTIdentifierNode *Id,
  ...
  ASTLengthOfNode *CreateASTLengthOfNode(const ASTIdentifierNode *Id,
                                         const ASTIdentifierNode *TId);

  ASTCallExpressionNode *CreateASTCallExpressionNode(
  ...
  ASTGateNode *
  CreateASTGateNode(const ASTIdentifierNode *Id, GateKind GK,
                    const ASTParameterList &PL, const ASTIdentifierList &IL,
                    const ASTGateQOpList &OL = ASTGateQOpList::EmptyDefault);
  ASTGateNode *
  CreateASTGateNode(const ASTIdentifierNode *Id, GateKind GK,
                    const ASTArgumentNodeList &AL, const ASTAnyTypeList &QL,
                    const ASTGateQOpList &OL = ASTGateQOpList::EmptyDefault);
  ...
  ASTDelayNode *CreateASTDelayNode(const ASTIdentifierNode *Id,
                                   const ASTIdentifierNode *TId,
  ...
  ASTDelayNode *CreateASTDelayNode(const ASTIdentifierNode *Id,
                                   ...
                                   const std::string &Time = "");
  ASTDelayNode *CreateASTDelayNode(const ASTIdentifierNode *DId,
                                   const ASTIdentifierList &IL,
                                   const std::string &Time = "");
  ASTDelayNode *CreateASTDelayNode(const ASTIdentifierNode *Id,
                                   const ASTDurationOfNode *DON,
  ...
  ASTStretchNode *CreateASTStretchNode(const ASTIdentifierNode *Id);
  ASTStretchNode *CreateASTStretchNode(const ASTIdentifierNode *Id,
                                       const std::string &LU);
  ASTStretchNode *CreateASTStretchNode(const ASTIdentifierNode *Id,
  ...
  ASTBoxExpressionNode *CreateASTBoxExpressionNode(const ASTIdentifierNode *Id,
                                                   const ASTStatementList &SL);
  ...
  ASTGateQOpNode *CreateASTGateControlStatement(const ASTIdentifierNode *Id,
                                                const ASTGateControlNode *GCN);
  ASTGateQOpNode *
  CreateASTGateNegControlStatement(const ASTIdentifierNode *Id,
                                   const ASTGateNegControlNode *GNCN);
  ASTGateQOpNode *CreateASTGateInverseStatement(const ASTIdentifierNode *Id,
                                                const ASTGateInverseNode *GIN);
  ASTGateQOpNode *CreateASTGatePowerStatement(const ASTIdentifierNode *Id,
                                              const ASTGatePowerNode *GPN);
  ASTGateQOpNode *
  CreateASTGateGPhaseStatement(const ASTIdentifierNode *Id,
                               const ASTGateGPhaseExpressionNode *GGN);

  ASTFunctionCallNode *CreateASTFunctionCallNode(const ASTIdentifierNode *Id,
  ...
  ASTFunctionCallNode *CreateASTFunctionCallNode(
      const std::string &EId, const ASTFunctionDefinitionNode *FDN,
      const ASTExpressionList *EL, const ASTIdentifierList *IL);

  ASTFunctionCallNode *CreateASTFunctionCallNode(const std::string &EId,
                                                 const ASTKernelNode *KN,
                                                 const ASTExpressionList *EL);
  ...
  ASTArrayNode *CreateASTCBitArrayNode(const ASTIdentifierNode *Id,
                                       const ASTIntNode *IX);
  ASTArrayNode *CreateASTCBitArrayNode(const ASTIdentifierNode *Id,
                                       unsigned Bits);
  ASTArrayNode *CreateASTCBitArrayNode(const ASTIdentifierNode *Id,
  ...
  ASTArrayNode *CreateASTQubitArrayNode(const ASTIdentifierNode *Id,
                                        const ASTIntNode *IX);
  ASTArrayNode *CreateASTQubitArrayNode(const ASTIdentifierNode *Id,
                                        unsigned Bits);
  ASTArrayNode *CreateASTQubitArrayNode(const ASTIdentifierNode *Id,
  ...
  ASTArrayNode *CreateASTAngleArrayNode(const ASTIdentifierNode *Id,
                                        const ASTIntNode *IX);
  ASTArrayNode *CreateASTAngleArrayNode(const ASTIdentifierNode *Id,
                                        unsigned Bits);
  ASTArrayNode *CreateASTAngleArrayNode(const ASTIdentifierNode *Id,
  ...
  ASTArrayNode *CreateASTBoolArrayNode(const ASTIdentifierNode *Id,
                                       const ASTIntNode *IX);
  ASTArrayNode *CreateASTBoolArrayNode(const ASTIdentifierNode *Id,
                                       unsigned Bits);
  ASTArrayNode *CreateASTIntArrayNode(const ASTIdentifierNode *Id,
                                      const ASTIntNode *IX,
                                      bool Unsigned = false);
  ASTArrayNode *CreateASTIntArrayNode(const ASTIdentifierNode *Id,
                                      unsigned Bits, bool Unsigned = false);
  ASTArrayNode *CreateASTMPIntegerArrayNode(const ASTIdentifierNode *Id,
                                            const ASTIntNode *IX,
  ...
  ASTArrayNode *CreateASTMPIntegerArrayNode(const ASTIdentifierNode *Id,
                                            ...
                                            bool Unsigned = false);
  ASTArrayNode *CreateASTFloatArrayNode(const ASTIdentifierNode *Id,
                                        const ASTIntNode *IX);
  ASTArrayNode *CreateASTFloatArrayNode(const ASTIdentifierNode *Id,
                                        unsigned Bits);
  ASTArrayNode *CreateASTMPDecimalArrayNode(const ASTIdentifierNode *Id,
                                            const ASTIntNode *IX,
                                            const ASTIntNode *FX);
  ASTArrayNode *CreateASTMPDecimalArrayNode(const ASTIdentifierNode *Id,
                                            unsigned Bits, unsigned MPBits);

  ASTArrayNode *CreateASTMPComplexArrayNode(const ASTIdentifierNode *Id,
                                            const ASTIntNode *IX,
                                            const ASTIntNode *CX);
  ASTArrayNode *CreateASTMPComplexArrayNode(const ASTIdentifierNode *Id,
  ...
  ASTArrayNode *CreateASTDurationArrayNode(const ASTIdentifierNode *Id,
                                           const ASTIntNode *IX,
  ...
  ASTArrayNode *CreateASTDurationArrayNode(const ASTIdentifierNode *Id,
                                           unsigned Bits,
                                           const ASTDurationOfNode *DON);
  ASTArrayNode *CreateASTOpenPulseFrameArrayNode(const ASTIdentifierNode *Id,
                                                 unsigned Size);
  ASTArrayNode *CreateASTOpenPulsePortArrayNode(const ASTIdentifierNode *Id,
                                                unsigned Size);
  ASTArrayNode *CreateASTOpenPulseWaveformArrayNode(const ASTIdentifierNode *Id,
                                                    unsigned Size);

  ASTIdentifierRefNode *
  CreateArrayASTIdentifierRefNode(const ASTIdentifierNode *Id, ASTType AType,
                                  ASTSymbolTableEntry *STE, unsigned Index);

  ASTEllipsisNode *CreateASTEllipsisNode(const ASTIdentifierNode *Id);

  // OpenPulse
  OpenPulse::ASTOpenPulseFrameNode *
  CreateASTOpenPulseFrameNode(const ASTIdentifierNode *Id,
                              const ASTExpressionList *EL, bool Extern = false);

  OpenPulse::ASTOpenPulsePortNode *
  CreateASTOpenPulsePortNode(const ASTIdentifierNode *Id, bool Extern = false);
  OpenPulse::ASTOpenPulsePortNode *
  CreateASTOpenPulsePortNode(const ASTIdentifierNode *Id, uint64_t PId,
                             bool Extern = false);
